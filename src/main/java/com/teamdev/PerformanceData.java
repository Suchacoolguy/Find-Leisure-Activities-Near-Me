...
public class PerformanceData {
    ...
    public String performanceData(String si, String gngu, String id) throws IOException {
        ...
        urlBuilder.append("&" + URLEncoder.encode("rows", "UTF-8") + "=" + URLEncoder.encode("10000", "UTF-8"));
        }
